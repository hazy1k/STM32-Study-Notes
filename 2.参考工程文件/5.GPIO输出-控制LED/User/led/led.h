...
// 这三个寄存器（GPIOx_ODR、GPIOx_BSRR、GPIOx_BRR）可以用来控制GPIO的引脚输出状态
// 指向BSRR寄存器的指针
...
#define LED1_ON			 digitalLo(LED1_GPIO_PORT, LED1_GPIO_PIN)     // 开启
...
void LED_GPIO_Config(void); // 函数声明
