 ...
 //其中 6 模式为大部分液晶例程的默认显示方向  
  NT35510_GramScan ( 6 );
	...
	while ( 1 )
	{
      ...
      NT35510_DispStringLine_EN_CH(6,dis_buf);
		}		
		else
		{
      ...
      NT35510_DispStringLine_EN_CH(2,(char* )"DHT11 initialization failed!");
      NT35510_DispStringLine_EN_CH(3,(char* )"Please check the connection!");	
		}
    HAL_Delay(1000); 
	}
}
