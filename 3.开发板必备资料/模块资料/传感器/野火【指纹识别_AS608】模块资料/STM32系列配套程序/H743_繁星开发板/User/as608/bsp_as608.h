...
#define AS608_USART_CLK()                        __HAL_RCC_UART5_CLK_ENABLE()
#define AS608_USART_BAUDRATE                    57600               //串口波特率

#define AS608_USART_RX_GPIO_PORT                GPIOD
#define AS608_USART_RX_GPIO_CLK()                __GPIOD_CLK_ENABLE()
#define AS608_USART_RX_PIN                      GPIO_PIN_2    
#define AS608_USART_RX_AF                       GPIO_AF8_UART5
...
#define AS608_USART_TX_AF                       GPIO_AF8_UART5
...
/*TouchOut引脚定义*/
#define AS608_TouchOut_INT_GPIO_PORT                GPIOH
#define AS608_TouchOut_INT_GPIO_CLK()               __GPIOH_CLK_ENABLE()
#define AS608_TouchOut_INT_GPIO_PIN                 GPIO_PIN_7
