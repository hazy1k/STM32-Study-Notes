...
#define SENSORS_I2C_SCL_GPIO_CLK_ENABLE()    	__GPIOH_CLK_ENABLE()
#define SENSORS_I2C_SCL_GPIO_PIN         		  GPIO_PIN_7
 
#define SENSORS_I2C_SDA_GPIO_PORT         		GPIOH
#define SENSORS_I2C_SDA_GPIO_CLK_ENABLE()   	__GPIOH_CLK_ENABLE()
#define SENSORS_I2C_SDA_GPIO_PIN          		GPIO_PIN_8

#define SENSORS_I2C_AF                    		GPIO_AF4_I2C3

#define SENSORS_I2C              		  		  I2C3
#define SENSORS_I2C_RCC_CLK_ENABLE()     		__HAL_RCC_I2C3_CLK_ENABLE()

#define SENSORS_I2C_FORCE_RESET()      			__HAL_RCC_I2C3_FORCE_RESET()
#define SENSORS_I2C_RELEASE_RESET()    			__HAL_RCC_I2C3_RELEASE_RESET()
