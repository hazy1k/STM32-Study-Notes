...
#define MPU6050_I2C_SCL_GPIO_PORT            GPIOH                       
#define MPU6050_I2C_SCL_GPIO_CLK_ENABLE()    __GPIOH_CLK_ENABLE()

#define MPU6050_I2C_SDA_PIN                  GPIO_PIN_8                 
#define MPU6050_I2C_SDA_GPIO_PORT            GPIOH                  
#define MPU6050_I2C_SDA_GPIO_CLK_ENABLE()    __GPIOH_CLK_ENABLE()
