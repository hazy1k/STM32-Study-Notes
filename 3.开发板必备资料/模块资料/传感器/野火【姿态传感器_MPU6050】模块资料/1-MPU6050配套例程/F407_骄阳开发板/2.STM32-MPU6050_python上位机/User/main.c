			  ...
			  if (inv_get_sensor_type_euler(data, &accuracy,(inv_time_t*)&timestamp))
						{
									...
									ILI9806G_DispStringLine_EN(LINE(10),(char* )cStr);	
						#endif
				...
				if (timestamp > hal.next_pedo_ms) {
						...
						dmp_get_pedometer_walk_time(&walk_time);				
									...
									ILI9806G_DispStringLine_EN(LINE(11),(char* )cStr);	 
						#endif				
				}
			}
...
int main(void)
{
  ...
  ILI9806G_Clear(0,0,LCD_X_LENGTH,LCD_Y_LENGTH);	/* 清屏，显示全黑 */
	...
	ILI9806G_DispStringLine_EN(LINE(1),(char* )"           This is a MPU6050 demo       ");	
	ILI9806G_DispStringLine_EN(LINE(2),(char* )"              (python version)       ");	
#endif
  /*初始化USART1*/
	DEBUG_USART_Config(); 
	EXTI_MPU_Config();
  ...
  if (result) {
      MPL_LOGE("Could not initialize gyro.\n");
							...
							ILI9806G_DispStringLine_EN(LINE(4),(char* )"No MPU6050 detected! ");			//野火自带的16*24显示
							ILI9806G_DispStringLine_EN(LINE(5),(char* )"Please check the hardware connection! ");			//野火自带的16*24显示
				#endif
  }
	else
	{	
				#ifdef USE_LCD_DISPLAY
							ILI9806G_DispStringLine_EN(LINE(4),(char* )"MPU6050 detected! ");			
				#endif
	}
