...
//  SCB_EnableDCache();
 ...
 //其中 6 模式为大部分液晶例程的默认显示方向  
  NT35510_GramScan ( 6 );
	...
	NT35510_DispStringLine_EN_CH(1,(uint8_t* )"DS18B20 temperature detect demo");
	/* 温度传感器初始化 */
		if(DS18B20_Init()==0)
	{
		printf("DS18B20初始化成功\n");
    ...
    NT35510_DispStringLine_EN_CH(2,(uint8_t* )"DS18B20 initialization failed!");
    NT35510_DispStringLine_EN_CH(3,(uint8_t* )"Please check the connection!");
		/* 停机 */
		while(1)
		{}
	}
  ...
  NT35510_DispStringLine_EN_CH(4,dis_buf);
    ...
    NT35510_DispStringLine_EN_CH(7,(uint8_t* )dis_buf);
    HAL_Delay(1000); 
	}
}
