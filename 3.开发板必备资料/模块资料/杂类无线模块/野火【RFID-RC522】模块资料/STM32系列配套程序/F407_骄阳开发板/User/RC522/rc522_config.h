...
/*********************************** RC522 引脚定义 *********************************************/
#define              RC522_GPIO_CS_CLK()                    __HAL_RCC_GPIOB_CLK_ENABLE()
#define              RC522_GPIO_CS_PORT    	                GPIOB		   
#define              RC522_GPIO_CS_PIN		                  GPIO_PIN_13

#define              RC522_GPIO_SCK_CLK()                   __HAL_RCC_GPIOB_CLK_ENABLE()
#define              RC522_GPIO_SCK_PORT    	              GPIOB			   
#define              RC522_GPIO_SCK_PIN		                  GPIO_PIN_14

#define              RC522_GPIO_MOSI_CLK()                  __HAL_RCC_GPIOB_CLK_ENABLE()
#define              RC522_GPIO_MOSI_PORT    	              GPIOB			   
#define              RC522_GPIO_MOSI_PIN		                GPIO_PIN_15

#define              RC522_GPIO_MISO_CLK()                  __HAL_RCC_GPIOC_CLK_ENABLE()
#define              RC522_GPIO_MISO_PORT    	              GPIOC		   
#define              RC522_GPIO_MISO_PIN		                GPIO_PIN_6

#define              RC522_GPIO_RST_CLK()                   __HAL_RCC_GPIOC_CLK_ENABLE()
