...
/*********************************** RC522 引脚定义 *********************************************/
#define              RC522_GPIO_CS_CLK()                      __HAL_RCC_GPIOF_CLK_ENABLE()
#define              RC522_GPIO_CS_PORT    	                GPIOF		   
#define              RC522_GPIO_CS_PIN		                  GPIO_PIN_7

#define              RC522_GPIO_SCK_CLK()                    __HAL_RCC_GPIOF_CLK_ENABLE()
#define              RC522_GPIO_SCK_PORT    	              GPIOF			   
#define              RC522_GPIO_SCK_PIN		                  GPIO_PIN_8

#define              RC522_GPIO_MOSI_CLK()                    __HAL_RCC_GPIOF_CLK_ENABLE()
#define              RC522_GPIO_MOSI_PORT    	              GPIOF			   
#define              RC522_GPIO_MOSI_PIN		                GPIO_PIN_9

#define              RC522_GPIO_MISO_CLK()                    __HAL_RCC_GPIOB_CLK_ENABLE()
#define              RC522_GPIO_MISO_PORT    	              GPIOB		   
#define              RC522_GPIO_MISO_PIN		                GPIO_PIN_10
