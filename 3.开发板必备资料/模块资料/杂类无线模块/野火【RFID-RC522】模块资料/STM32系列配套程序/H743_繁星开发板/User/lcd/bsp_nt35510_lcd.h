...
64MB:FMC_Bank1_NORSRAM1:0X6000 0000 ~ 0X63FF FFFF
64MB:FMC_Bank1_NORSRAM2:0X6400 0000 ~ 0X67FF FFFF
64MB:FMC_Bank1_NORSRAM3:0X6800 0000 ~ 0X6BFF FFFF
64MB:FMC_Bank1_NORSRAM4:0X6C00 0000 ~ 0X6FFF FFFF

选择BANK1-BORSRAM3 连接 TFT，地址范围为0X6800 0000 ~ 0X6BFF FFFF
FMC_A0 接LCD的DC(寄存器/数据选择)脚
寄存器基地址 = 0X6C00 0000
RAM基地址 = 0X6D00 0000 = 0X6C00 0000+2^0*2 = 0X6800 0000 + 0X2 = 0X6800 0002
当选择不同的地址线时，地址要重新计算  
****************************************************************************************/

/******************************* NT35510 显示屏的 FMC 参数定义 ***************************/
//FMC_Bank1_NORSRAM用于LCD命令操作的地址
#define       FMC_Addr_NT35510_CMD         ( ( uint32_t ) 0x68000000 )

//FMC_Bank1_NORSRAM用于LCD数据操作的地址      
#define       FMC_Addr_NT35510_DATA        ( ( uint32_t ) 0x68000002 )

//由片选引脚决定的NOR/SRAM块
#define       FMC_Bankx_NORSRAMx           FMC_NORSRAM_BANK3

// MPU保护参数
#define       FMC_REGION_NUMBER		         MPU_REGION_NUMBER0		      // 使用region0
#define       FMC_ADDRESS_START		         (FMC_Addr_NT35510_CMD)			// 使用的首地址
