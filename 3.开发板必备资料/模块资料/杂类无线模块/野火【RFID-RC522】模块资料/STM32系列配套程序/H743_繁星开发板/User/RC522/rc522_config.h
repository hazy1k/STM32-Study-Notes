...
/*********************************** RC522 引脚定义 *********************************************/
#define              RC522_GPIO_CS_CLK()                      __HAL_RCC_GPIOH_CLK_ENABLE()
#define              RC522_GPIO_CS_PORT    	                GPIOH
#define              RC522_GPIO_CS_PIN		                  GPIO_PIN_12

#define              RC522_GPIO_SCK_CLK()                    __HAL_RCC_GPIOH_CLK_ENABLE()
#define              RC522_GPIO_SCK_PORT    	              GPIOH  
#define              RC522_GPIO_SCK_PIN		                  GPIO_PIN_10

#define              RC522_GPIO_MOSI_CLK()                    __HAL_RCC_GPIOH_CLK_ENABLE()
#define              RC522_GPIO_MOSI_PORT    	              GPIOH		   
#define              RC522_GPIO_MOSI_PIN		                GPIO_PIN_15

#define              RC522_GPIO_MISO_CLK()                    __HAL_RCC_GPIOH_CLK_ENABLE()
#define              RC522_GPIO_MISO_PORT    	              GPIOH			   
#define              RC522_GPIO_MISO_PIN		                GPIO_PIN_14

#define              RC522_GPIO_RST_CLK()                     __HAL_RCC_GPIOH_CLK_ENABLE()
