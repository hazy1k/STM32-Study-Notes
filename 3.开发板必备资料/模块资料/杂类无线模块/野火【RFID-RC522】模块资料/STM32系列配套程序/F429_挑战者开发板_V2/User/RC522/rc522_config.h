...
#define              RC522_GPIO_CS_CLK                      RCC_AHB1Periph_GPIOC
...
#define              RC522_GPIO_SCK_CLK                     RCC_AHB1Periph_GPIOF
#define              RC522_GPIO_SCK_PORT    	              GPIOF			   
#define              RC522_GPIO_SCK_PIN		                  GPIO_Pin_6
#define              RC522_GPIO_SCK_Mode		                GPIO_Mode_OUT

#define              RC522_GPIO_MOSI_CLK_FUN                RCC_AHB1PeriphClockCmd
#define              RC522_GPIO_MOSI_CLK                    RCC_AHB1Periph_GPIOF
...
#define              RC522_GPIO_MISO_CLK                    RCC_AHB1Periph_GPIOF
#define              RC522_GPIO_MISO_PORT    	              GPIOF			   
#define              RC522_GPIO_MISO_PIN		                GPIO_Pin_8
#define              RC522_GPIO_MISO_Mode		                GPIO_Mode_IN

#define              RC522_GPIO_RST_CLK_FUN                 RCC_AHB1PeriphClockCmd
#define              RC522_GPIO_RST_CLK                     RCC_AHB1Periph_GPIOF
#define              RC522_GPIO_RST_PORT    	              GPIOF	   
#define              RC522_GPIO_RST_PIN		                  GPIO_Pin_9
