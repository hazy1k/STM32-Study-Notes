...
/*********************************** RC522 引脚定义 *********************************************/
#define              RC522_GPIO_CS_CLK()                      __HAL_RCC_GPIOD_CLK_ENABLE()
#define              RC522_GPIO_CS_PORT    	                GPIOD		   
#define              RC522_GPIO_CS_PIN		                  GPIO_PIN_11

#define              RC522_GPIO_SCK_CLK()                    __HAL_RCC_GPIOD_CLK_ENABLE()
#define              RC522_GPIO_SCK_PORT    	              GPIOD			   
#define              RC522_GPIO_SCK_PIN		                  GPIO_PIN_12

#define              RC522_GPIO_MOSI_CLK()                    __HAL_RCC_GPIOA_CLK_ENABLE()
#define              RC522_GPIO_MOSI_PORT    	              GPIOA			   
#define              RC522_GPIO_MOSI_PIN		                GPIO_PIN_12

#define              RC522_GPIO_MISO_CLK()                    __HAL_RCC_GPIOB_CLK_ENABLE()
#define              RC522_GPIO_MISO_PORT    	              GPIOB			   
#define              RC522_GPIO_MISO_PIN		                GPIO_PIN_12

#define              RC522_GPIO_RST_CLK()                     __HAL_RCC_GPIOB_CLK_ENABLE()
#define              RC522_GPIO_RST_PORT    	              GPIOB		   
#define              RC522_GPIO_RST_PIN		                  GPIO_PIN_13
