...
#define VS_SCLK_PINSOURCE     GPIO_PinSource1
#define VS_MISO								GPIO_Pin_2								/*定义VS1053的MISO管脚*/
#define VS_MISO_PINSOURCE     GPIO_PinSource2
#define VS_MOSI								GPIO_Pin_3								/*定义VS1053的MOSI管脚*/
#define VS_MOSI_PINSOURCE     GPIO_PinSource3
#define VS_SPIGPIO_PORT				GPIOI											/* GPIO端口 */
#define VS_SPIGPIO_CLK				RCC_AHB1Periph_GPIOI			/* GPIO端口时钟 */

#define VS_SPI_AF					  	GPIO_AF_SPI2
#define VS_SPI								SPI2
#define VS_SPI_CLK						RCC_APB1Periph_SPI2

#define VS_XDCS								GPIO_Pin_2								/*定义VS1053的片选管脚*/
#define VS_GPIO_XDCS_PORT			GPIOD											/* GPIO端口 */
#define VS_GPIO_XDCS_CLK			RCC_AHB1Periph_GPIOD			/* GPIO端口时钟 */

#define VS_GPIO_RST_PORT			GPIOC											/* GPIO端口 */
#define VS_GPIO_RST_CLK				RCC_AHB1Periph_GPIOC					/* GPIO端口时钟 */
#define VS_RST								GPIO_Pin_12								/*定义VS1053的RST管脚*/

#define VS_GPIO_DREQ_PORT			GPIOH											/* GPIO端口 */
#define VS_GPIO_DREQ_CLK			RCC_AHB1Periph_GPIOH			/* GPIO端口时钟 */
