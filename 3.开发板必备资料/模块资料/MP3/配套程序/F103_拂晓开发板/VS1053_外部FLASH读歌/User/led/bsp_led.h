...
#define macLED1_GPIO_PIN		  GPIO_Pin_8		          /* LED引脚号 */

#define macLED2_GPIO_PORT    	GPIOA		                /* GPIO端口 */
#define macLED2_GPIO_CLK 	    RCC_APB2Periph_GPIOA		/* GPIO端口时钟 */
#define macLED2_GPIO_PIN		  GPIO_Pin_9			         /* LED引脚号 */

#define macLED3_GPIO_PORT    	GPIOA			              /* GPIO端口 */
#define macLED3_GPIO_CLK 	    RCC_APB2Periph_GPIOA		/* GPIO端口时钟 */
#define macLED3_GPIO_PIN		  GPIO_Pin_10			          /* LED引脚号 */

#define macLED4_GPIO_PORT    	GPIOE			              /* GPIO端口 */
#define macLED4_GPIO_CLK 	    RCC_APB2Periph_GPIOE		/* GPIO端口时钟 */
#define macLED4_GPIO_PIN		  GPIO_Pin_14			          /* LED引脚号 */
