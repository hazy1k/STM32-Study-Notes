...
#define VS_XCS								GPIO_Pin_9								/*定义VS1053的片选管脚*/
#define VS_SCLK								GPIO_Pin_8								/*定义VS1053的时钟管脚*/
#define VS_MISO								GPIO_Pin_11								/*定义VS1053的MISO管脚*/
#define VS_MOSI								GPIO_Pin_10								/*定义VS1053的MOSI管脚*/
#define VS_SPIGPIO_PORT				GPIOE										  /* GPIO端口 */
#define VS_SPIGPIO_CLK				RCC_APB2Periph_GPIOE			/* GPIO端口时钟 */

#define VS_XDCS								GPIO_Pin_12							/*定义VS1053的片选管脚*/
#define VS_GPIO_XDCS_PORT			GPIOD											/* GPIO端口 */
#define VS_GPIO_XDCS_CLK			RCC_APB2Periph_GPIOD			/* GPIO端口时钟 */

#define VS_GPIO_RST_PORT			GPIOE											/* GPIO端口 */
#define VS_GPIO_RST_CLK				RCC_APB2Periph_GPIOE					/* GPIO端口时钟 */
...
#define VS_DREQ								GPIO_Pin_13								/*定义VS1053的DREQ管脚*/
...
#define VS_SCLK_0            GPIO_ResetBits(VS_SPIGPIO_PORT,VS_SCLK)
#define VS_SCLK_1            GPIO_SetBits (VS_SPIGPIO_PORT,VS_SCLK)

#define VS_CS_Enable        GPIO_ResetBits (VS_SPIGPIO_PORT, VS_XCS)
#define VS_CS_Disable        GPIO_SetBits (VS_SPIGPIO_PORT,VS_XCS)


#define VS_MOSI_0            GPIO_ResetBits(VS_SPIGPIO_PORT,VS_MOSI)
#define VS_MOSI_1            GPIO_SetBits (VS_SPIGPIO_PORT,VS_MOSI)

#define VS_MISO_GET          GPIO_ReadInputDataBit (VS_SPIGPIO_PORT,VS_MISO)
//////////////////////////////////////////////////////////////
