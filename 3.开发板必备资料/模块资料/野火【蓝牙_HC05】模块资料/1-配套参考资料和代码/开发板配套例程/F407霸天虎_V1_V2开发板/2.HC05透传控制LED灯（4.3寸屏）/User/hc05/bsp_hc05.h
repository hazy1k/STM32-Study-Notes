...
#define BLT_INT_GPIO_PORT    	GPIOF			              /* GPIO端口 */
#define BLT_INT_GPIO_CLK 	    RCC_AHB1Periph_GPIOF		/* GPIO端口时钟 */
#define BLT_INT_GPIO_PIN		  	GPIO_Pin_10			          /* 连接到HC05 INT引脚的GPIO */

#define BLT_KEY_GPIO_PORT    	GPIOB			              /* GPIO端口 */
#define BLT_KEY_GPIO_CLK 	    RCC_AHB1Periph_GPIOB		/* GPIO端口时钟 */
...
/*使用屏幕显示*/
//#define ENABLE_LCD_DISPLAY    //切换液晶显示宏  使用野火【电容触摸屏NT35510_GT917S_4.3寸】
