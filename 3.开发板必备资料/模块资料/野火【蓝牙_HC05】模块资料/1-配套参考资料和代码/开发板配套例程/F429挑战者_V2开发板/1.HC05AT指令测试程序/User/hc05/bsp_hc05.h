...
#define BLT_INT_GPIO_PORT    	GPIOI			              /* GPIO端口 */
#define BLT_INT_GPIO_CLK 	    RCC_AHB1Periph_GPIOI		/* GPIO端口时钟 */
#define BLT_INT_GPIO_PIN		  	GPIO_Pin_3			          /* 连接到HC05 INT引脚的GPIO */

#define BLT_KEY_GPIO_PORT    	GPIOC			              /* GPIO端口 */
#define BLT_KEY_GPIO_CLK 	    RCC_AHB1Periph_GPIOC		/* GPIO端口时钟 */
#define BLT_KEY_GPIO_PIN		    GPIO_Pin_2		          /* 连接到HC05 KEY引脚的GPIO */
...
/*使用屏幕显示*/
//#define ENABLE_LCD_DISPLAY    //切换液晶显示宏 使用RGB屏幕
