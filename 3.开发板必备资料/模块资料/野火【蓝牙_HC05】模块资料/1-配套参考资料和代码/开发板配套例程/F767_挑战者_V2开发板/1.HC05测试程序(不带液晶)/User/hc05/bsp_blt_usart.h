...
#define BLT_RCC_PERIPHCLK_UARTx               RCC_PERIPHCLK_USART6
#define BLT_RCC_UARTxCLKSOURCE_SYSCLK         RCC_USART6CLKSOURCE_PCLK2
...
#define BLT_UARTx_RX_AF                          GPIO_AF8_USART6
...
#define BLT_UARTx_TX_AF                       GPIO_AF8_USART6
