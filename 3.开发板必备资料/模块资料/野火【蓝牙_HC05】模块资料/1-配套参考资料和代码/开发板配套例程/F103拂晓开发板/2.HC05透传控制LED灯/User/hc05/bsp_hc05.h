...
#define BLT_INT_GPIO_PORT    	GPIOD			              /* GPIO端口 */
#define BLT_INT_GPIO_CLK 	    RCC_APB2Periph_GPIOD		/* GPIO端口时钟 */
#define BLT_INT_GPIO_PIN		  	GPIO_Pin_11			          /* 连接到HC05 INT引脚的GPIO */

#define BLT_KEY_GPIO_PORT    	GPIOD			              /* GPIO端口 */
#define BLT_KEY_GPIO_CLK 	    RCC_APB2Periph_GPIOD		/* GPIO端口时钟 */
#define BLT_KEY_GPIO_PIN		    GPIO_Pin_10		          /* 连接到HC05 KEY引脚的GPIO */
