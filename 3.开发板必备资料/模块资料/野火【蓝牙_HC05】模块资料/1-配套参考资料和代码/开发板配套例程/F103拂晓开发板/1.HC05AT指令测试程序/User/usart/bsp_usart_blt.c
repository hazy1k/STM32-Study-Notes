...
void BLT_USART_Config(void)
{
	...
	/* config USART2 clock */
	BLT_USART_APBxClock_FUN(BLT_USART_CLK, ENABLE);                               //打开USART3时钟  APB1
  BLT_USART_GPIO_APBxClock_FUN(BLT_USART_GPIO_CLK|RCC_APB2Periph_AFIO, ENABLE); //开启GPIOB时钟、remap时钟   APB2
