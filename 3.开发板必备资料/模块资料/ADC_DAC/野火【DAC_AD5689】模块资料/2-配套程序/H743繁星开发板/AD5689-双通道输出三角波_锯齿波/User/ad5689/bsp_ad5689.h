...
#define AD5689_SPIx                SPI2
#define AD5689_SPIx_CLK_ENABLE()    __HAL_RCC_SPI2_CLK_ENABLE()
#define AD5689_GPIO_CLK_ENABLE()   {__HAL_RCC_GPIOI_CLK_ENABLE();__HAL_RCC_GPIOA_CLK_ENABLE();} 
#define AD5689_SYNC_Pin            GPIO_PIN_0   //SYNC
#define AD5689_SYNC_GPIO_Port      GPIOI
#define AD5689_SCK_Pin             GPIO_PIN_1   //SCLK
#define AD5689_SCK_GPIO_Port       GPIOI
#define AD5689_MISO_Pin            GPIO_PIN_2   //SDO
#define AD5689_MISO_GPIO_Port      GPIOI
#define AD5689_MOSI_Pin            GPIO_PIN_3   //SDIN
#define AD5689_MOSI_GPIO_Port      GPIOI
