...
#define AD5689_GPIO_CLK_ENABLE()   {__HAL_RCC_GPIOA_CLK_ENABLE();__HAL_RCC_GPIOB_CLK_ENABLE();} 
#define AD5689_SYNC_Pin            GPIO_PIN_3   //SYNC
#define AD5689_SYNC_GPIO_Port      GPIOA
#define AD5689_SCK_Pin             GPIO_PIN_5   //SCLK
#define AD5689_SCK_GPIO_Port       GPIOA
#define AD5689_MISO_Pin            GPIO_PIN_4   //SDO
#define AD5689_MISO_GPIO_Port      GPIOB
#define AD5689_MOSI_Pin            GPIO_PIN_5   //SDIN
