...
#define AD5689_SYNC_CLK_ENABLE()   __HAL_RCC_GPIOE_CLK_ENABLE()
#define AD5689_SCK_CLK_ENABLE()    __HAL_RCC_GPIOE_CLK_ENABLE()
#define AD5689_MISO_CLK_ENABLE()   __HAL_RCC_GPIOE_CLK_ENABLE()
#define AD5689_MOSI_CLK_ENABLE()   __HAL_RCC_GPIOE_CLK_ENABLE()

#define AD5689_SYNC_Pin            GPIO_PIN_8   //SYNC
#define AD5689_SYNC_GPIO_Port      GPIOE
#define AD5689_SCK_Pin             GPIO_PIN_9   //SCLK
#define AD5689_SCK_GPIO_Port       GPIOE
#define AD5689_MISO_Pin            GPIO_PIN_10   //SDO
#define AD5689_MISO_GPIO_Port      GPIOE
#define AD5689_MOSI_Pin            GPIO_PIN_11   //SDIN
#define AD5689_MOSI_GPIO_Port      GPIOE

/**AD5689**/
#define AD5689_LDAC_Pin            GPIO_PIN_0   //LDAC
#define AD5689_LDAC_GPIO_Port      GPIOB
#define AD5689_RESET_Pin           GPIO_PIN_1   //RESET
#define AD5689_RESET_GPIO_Port     GPIOB
