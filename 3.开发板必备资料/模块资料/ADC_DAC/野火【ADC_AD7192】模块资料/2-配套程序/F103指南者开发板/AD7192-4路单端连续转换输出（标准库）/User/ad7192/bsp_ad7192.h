...
#define AD7192_CS_ENABLE()         GPIO_ResetBits(AD7192_SPI_CS_PORT,AD7192_SPI_CS_PIN)
#define AD7192_CS_DISABLE()        GPIO_SetBits(AD7192_SPI_CS_PORT,AD7192_SPI_CS_PIN)
