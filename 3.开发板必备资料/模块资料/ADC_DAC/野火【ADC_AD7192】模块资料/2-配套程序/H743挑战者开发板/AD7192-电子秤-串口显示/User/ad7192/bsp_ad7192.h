...
#define AD7192_SPIx                SPI5
#define AD7192_SPIx_CLK_ENABLE()   __HAL_RCC_SPI5_CLK_ENABLE()
#define AD7192_GPIO_CLK_ENABLE()   __HAL_RCC_GPIOF_CLK_ENABLE();
#define AD7192_CS_Pin              GPIO_PIN_6
#define AD7192_CS_GPIO_Port        GPIOF
#define AD7192_SCK_Pin             GPIO_PIN_7
#define AD7192_SCK_GPIO_Port       GPIOF
#define AD7192_MISO_Pin            GPIO_PIN_8   //DOUT
#define AD7192_MISO_GPIO_Port      GPIOF
#define AD7192_MOSI_Pin            GPIO_PIN_9   //DIN
#define AD7192_MOSI_GPIO_Port      GPIOF
