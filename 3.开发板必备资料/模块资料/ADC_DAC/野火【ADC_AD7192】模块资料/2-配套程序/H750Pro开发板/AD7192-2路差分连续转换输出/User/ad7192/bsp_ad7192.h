...
#define AD7192_GPIO_CLK_ENABLE()   {__HAL_RCC_GPIOC_CLK_ENABLE();__HAL_RCC_GPIOD_CLK_ENABLE();}
#define AD7192_CS_Pin              GPIO_PIN_12
#define AD7192_CS_GPIO_Port        GPIOD
#define AD7192_SCK_Pin             GPIO_PIN_10
#define AD7192_SCK_GPIO_Port       GPIOC
#define AD7192_MISO_Pin            GPIO_PIN_11   //DOUT
#define AD7192_MISO_GPIO_Port      GPIOC
#define AD7192_MOSI_Pin            GPIO_PIN_6   //DIN
#define AD7192_MOSI_GPIO_Port      GPIOD
