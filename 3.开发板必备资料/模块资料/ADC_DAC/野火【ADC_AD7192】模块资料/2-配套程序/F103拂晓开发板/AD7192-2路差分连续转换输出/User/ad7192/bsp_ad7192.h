...
//-----------------端口定义----------------
//由于拂晓没有预留硬件SPI硬件，所以采用软件模拟
//#define AD7192_SPIx                SPI3
//#define AD7192_SPIx_CLK_ENABLE()   __HAL_RCC_SPI3_CLK_ENABLE()
//#define AD7192_GPIO_CLK_ENABLE()   __HAL_RCC_GPIOB_CLK_ENABLE();

#define AD7192_CS_CLK_ENABLE()   	 __HAL_RCC_GPIOE_CLK_ENABLE();
#define AD7192_SCK_CLK_ENABLE()    __HAL_RCC_GPIOE_CLK_ENABLE();
#define AD7192_MISO_CLK_ENABLE()   __HAL_RCC_GPIOE_CLK_ENABLE();
#define AD7192_MOSI_CLK_ENABLE()   __HAL_RCC_GPIOE_CLK_ENABLE();

#define AD7192_CS_Pin              GPIO_PIN_8
#define AD7192_CS_GPIO_Port        GPIOE
#define AD7192_SCK_Pin             GPIO_PIN_9
#define AD7192_SCK_GPIO_Port       GPIOE
#define AD7192_MISO_Pin            GPIO_PIN_10   //DOUT
#define AD7192_MISO_GPIO_Port      GPIOE
#define AD7192_MOSI_Pin            GPIO_PIN_11   //DIN
#define AD7192_MOSI_GPIO_Port      GPIOE
