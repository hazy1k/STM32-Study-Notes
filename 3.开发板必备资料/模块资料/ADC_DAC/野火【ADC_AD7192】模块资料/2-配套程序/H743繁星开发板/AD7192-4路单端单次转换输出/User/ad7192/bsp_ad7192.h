...
#define AD7192_SPIx                SPI2
#define AD7192_SPIx_CLK_ENABLE()   __HAL_RCC_SPI2_CLK_ENABLE()
#define AD7192_GPIO_CLK_ENABLE()   __HAL_RCC_GPIOI_CLK_ENABLE()
#define AD7192_CS_Pin              GPIO_PIN_0
#define AD7192_CS_GPIO_Port        GPIOI
#define AD7192_SCK_Pin             GPIO_PIN_1
#define AD7192_SCK_GPIO_Port       GPIOI
#define AD7192_MISO_Pin            GPIO_PIN_2   //DOUT
#define AD7192_MISO_GPIO_Port      GPIOI
#define AD7192_MOSI_Pin            GPIO_PIN_3   //DIN
#define AD7192_MOSI_GPIO_Port      GPIOI
