...
/*=========================================================================================*/
#define	__lcd_write_cmd(cmd)  ILI9341_Write_Cmd(cmd)
#define	__lcd_write_dat(dat) 	ILI9341_Write_Data(dat)
#define	__lcd_read_dat()			ILI9341_Read_Data
...
void __lcd_write_start(u16 sx,u16 sy,u16 ex,u16 ey)
{
	...
	ILI9341_Write_Data(sx>>8);
	ILI9341_Write_Data(sx);
	ILI9341_Write_Data(ex>>8);
	ILI9341_Write_Data(ex);

	ILI9341_Write_Cmd(0x2B);
	ILI9341_Write_Data(sy>>8);
	ILI9341_Write_Data(sy);
	ILI9341_Write_Data(ey>>8);
	ILI9341_Write_Data(ey);
...
void __lcd_read_start(u16 sx,u16 sy,u16 ex,u16 ey)
{
	...
	c =ILI9341_Read_Data(); //DummyRead
	for(c=0;c<2;c++);
}

void __lcd_write_rgb(uint8_t r,uint8_t g,uint8_t b)
{
	ILI9341_Write_Data(__lcd_map_rgb(r,g,b));
}
...
u16 __lcd_read_pixel(void)
{
	...
	c1 =ILI9341_Read_Data(); //RG
	c2 =ILI9341_Read_Data(); //BX
