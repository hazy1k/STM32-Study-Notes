...
/* 默认内部中文字体数组名 */
#define GUI_DEFAULT_FONT_CN          ASCII_16_4BPP
...
#define GUI_DEFAULT_EXTERN_FONT   "ASCII_16_4BPP.xft"//gui_font_param[cur_lcd].default_extern_cn
