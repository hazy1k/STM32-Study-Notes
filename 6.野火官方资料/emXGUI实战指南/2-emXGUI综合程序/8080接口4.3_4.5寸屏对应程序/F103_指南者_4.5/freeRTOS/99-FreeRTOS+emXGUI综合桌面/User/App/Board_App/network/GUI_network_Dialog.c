...
static LRESULT	win_proc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
  switch(msg)
  {
    case WM_CREATE:
    {
      ...
      rc.x = 400;
      rc.y = 244;
      CreateWindow(TEXTBOX, L"你好！这里是野火开发板 ^_^ IP显示仅供参考,具体查看头文件w5500_conf.h", WS_TRANSPARENT | WS_VISIBLE|WS_OWNERDRAW, rc.x, rc.y, rc.w, rc.h, hwnd, ID_TEXTBOX_Send, NULL, NULL);
      ...
      rc.x = 497;
      rc.y = 148;
			/* IP显示仅供参考,具体查看头文件w5500_conf.h */
      Temp_Handle = CreateWindow(TEXTBOX, L"192.168.0.101", WS_VISIBLE|WS_OWNERDRAW|WS_DISABLED, rc.x, rc.y, rc.w, rc.h, hwnd, ID_TEXTBOX_RemoteIP, NULL, NULL);//
