...
int MessageDialogBox(HWND Phwnd, RECT rc,const WCHAR *pText,const WCHAR *pCaption,const MSGBOX_OPTIONS *ops)
{
  WNDCLASS	wcex;
	MSG  msg;
  HWND hwnd;
  ...
  opsInt = ops;
	...
	//创建主窗口
	hwnd = CreateWindowEx(WS_EX_NOFOCUS|WS_EX_LOCKZORDER,//WS_EX_FRAMEBUFFER
                      &wcex,
                      L"GUI_Camera_Dialog",
                      WS_CLIPCHILDREN,
                      rc.x, rc.y, rc.w, rc.h,
