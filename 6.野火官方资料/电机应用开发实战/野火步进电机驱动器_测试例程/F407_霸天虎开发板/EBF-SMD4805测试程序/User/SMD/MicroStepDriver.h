...
// 这里我们使用定时器TIM1
#define            SMD_PULSE_TIM                    TIM1
#define            SMD_PULSE_TIM_APBxClock_FUN      RCC_APB2PeriphClockCmd
#define            SMD_PULSE_TIM_CLK                RCC_APB2Periph_TIM1
...
// 定时器中断
#define            SMD_PULSE_TIM_IRQ                TIM1_UP_TIM10_IRQn
#define            SMD_PULSE_TIM_IRQHandler         TIM1_UP_TIM10_IRQHandler

// PWM 信号的频率 F = TIM_CLK/{(ARR+1)*(PSC+1)}
#define            SMD_PULSE_TIM_PERIOD             (10)
#define            SMD_PULSE_TIM_PSC                (168)

// 步进电机脉冲输出通道
#define            SMD_PULSE_AHBxClock_FUN          RCC_AHB1PeriphClockCmd
#define            SMD_PULSE_GPIO_CLK               RCC_AHB1Periph_GPIOE
#define            SMD_PULSE_PORT                   GPIOE
#define            SMD_PULSE_PIN                    GPIO_Pin_9
#define            SMD_PULSE_PIN_AF                 GPIO_AF_TIM1
#define            SMD_PULSE_PIN_SOURCE             GPIO_PinSource9

// 步进电机方向控制
#define            SMD_DIR_AHBxClock_FUN            RCC_AHB1PeriphClockCmd
#define            SMD_DIR_GPIO_CLK                 RCC_AHB1Periph_GPIOE
#define            SMD_DIR_PORT                     GPIOE
#define            SMD_DIR_PIN                      GPIO_Pin_7

// 步进电机输出使能引脚
#define            SMD_ENA_AHBxClock_FUN            RCC_AHB1PeriphClockCmd
#define            SMD_ENA_GPIO_CLK                 RCC_AHB1Periph_GPIOD
#define            SMD_ENA_PORT                     GPIOD
#define            SMD_ENA_PIN                      GPIO_Pin_0
...
//// 步进电机脉冲输出通道
//#define            SMD_PULSE_AHBxClock_FUN          RCC_AHB1PeriphClockCmd
//#define            SMD_PULSE_GPIO_CLK               RCC_AHB1Periph_GPIOA
//#define            SMD_PULSE_PORT                   GPIOA
//#define            SMD_PULSE_PIN                    GPIO_Pin_3
//#define            SMD_PULSE_PIN_AF                 GPIO_AF_TIM2
//#define            SMD_PULSE_PIN_SOURCE             GPIO_PinSource3

//// 步进电机方向控制
//#define            SMD_DIR_AHBxClock_FUN            RCC_AHB1PeriphClockCmd
//#define            SMD_DIR_GPIO_CLK                 RCC_AHB1Periph_GPIOC
//#define            SMD_DIR_PORT                     GPIOC
//#define            SMD_DIR_PIN                      GPIO_Pin_0

//// 步进电机输出使能引脚
//#define            SMD_ENA_AHBxClock_FUN            RCC_AHB1PeriphClockCmd
//#define            SMD_ENA_GPIO_CLK                 RCC_AHB1Periph_GPIOB
//#define            SMD_ENA_PORT                     GPIOB
//#define            SMD_ENA_PIN                      GPIO_Pin_14
