...
// 定时器中断
#define            SMD_PULSE_TIM_IRQ                TIM8_UP_TIM13_IRQn
#define            SMD_PULSE_TIM_IRQHandler         TIM8_UP_TIM13_IRQHandler
...
#define            SMD_PULSE_GPIO_CLK               RCC_AHB1Periph_GPIOC
#define            SMD_PULSE_PORT                   GPIOC
#define            SMD_PULSE_PIN                    GPIO_Pin_6
#define            SMD_PULSE_PIN_AF                 GPIO_AF_TIM8
#define            SMD_PULSE_PIN_SOURCE             GPIO_PinSource6

// 步进电机方向控制
#define            SMD_DIR_AHBxClock_FUN            RCC_AHB1PeriphClockCmd
#define            SMD_DIR_GPIO_CLK                 RCC_AHB1Periph_GPIOB
