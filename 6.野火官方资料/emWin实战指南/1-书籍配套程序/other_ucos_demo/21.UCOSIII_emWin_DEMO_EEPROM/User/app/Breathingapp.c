...
static void _cbDialogBreathing(WM_MESSAGE * pMsg) {
  ...
  case WM_NOTIFY_PARENT:
    ...
    case GUI_ID_EDIT0: // Notifications sent by 'rEdit'
      ...
      case WM_NOTIFICATION_RELEASED:
        // USER START (Optionally insert code for reacting on notification message)
				messagesbln[0]=WM_GetDialogItem(pMsg->hWin, GUI_ID_EDIT0);
				messagesbln[1]=GUI_ID_EDIT0;
    ...
    case GUI_ID_EDIT1: // Notifications sent by 'gEdit'
      ...
      case WM_NOTIFICATION_RELEASED:
        // USER START (Optionally insert code for reacting on notification message)
				messagesbln[0]=WM_GetDialogItem(pMsg->hWin, GUI_ID_EDIT1);
				messagesbln[1]=GUI_ID_EDIT1;
				if(!keypadflag)OSTaskQPost(&AppTaskKeypadTCB,
																(void *)&messagesbln,
																2,
																OS_OPT_POST_FIFO,
    ...
    case GUI_ID_EDIT2: // Notifications sent by 'bEdit'
      ...
      case WM_NOTIFICATION_RELEASED:
        // USER START (Optionally insert code for reacting on notification message)
					messagesbln[0]=WM_GetDialogItem(pMsg->hWin, GUI_ID_EDIT2);
					messagesbln[1]=GUI_ID_EDIT2;
					if(!keypadflag)OSTaskQPost(&AppTaskKeypadTCB,
																	(void *)&messagesbln,
																	2,
																	OS_OPT_POST_FIFO,
