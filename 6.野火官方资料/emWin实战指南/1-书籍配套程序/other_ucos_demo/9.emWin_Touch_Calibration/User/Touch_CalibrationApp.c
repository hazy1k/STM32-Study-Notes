...
//  GUI_Init();
  ...
  GUI_TOUCH_Calibrate(GUI_COORD_X, aLogX[0], aLogX[1], aPhysX[1], aPhysX[0]); /* Calibrate X-axis */
  GUI_TOUCH_Calibrate(GUI_COORD_Y, aLogY[0], aLogY[1], aPhysY[1], aPhysY[0]); /* Calibrate Y-axis */
  printf("\nGUI_COORD_X:aLogX[0]=%d,aLogX[1]=%d,aPhysX[1]=%d,aPhysX[0]=%d\n",aLogX[0], aLogX[1], aPhysX[1], aPhysX[0]);
  printf("\nGUI_COORD_Y:aLogY[0]=%d,aLogY[1]=%d,aPhysY[1]=%d,aPhysY[0]=%d\n",aLogY[0], aLogY[1], aPhysY[1], aPhysY[0]);
  
  GUI_TOUCH_GetCalData(GUI_COORD_X, &aPhysX[1], &aPhysX[0]);
  GUI_TOUCH_GetCalData(GUI_COORD_Y, &aPhysY[1], &aPhysY[0]);
  printf("\nCalData_X:aLogX[0]=%d,aLogX[1]=%d,aPhysX[1]=%d,aPhysX[0]=%d\n",0, 239, aPhysX[1], aPhysX[0]);
  printf("\nCalData_Y:aLogY[0]=%d,aLogY[1]=%d,aPhysY[1]=%d,aPhysY[0]=%d\n",0, 319, aPhysY[1], aPhysY[0]);
  /* Display the result */
  GUI_CURSOR_Show();
  GUI_Clear();
