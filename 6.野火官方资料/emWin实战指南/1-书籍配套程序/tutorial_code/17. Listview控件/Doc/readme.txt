...
表格控件用于多种类型数据的选择和管理，表格视图内的项目被选中时它们会高亮显示
实验现象：点击表格控件中的某一行会在下发显示当前行的文本信息，点击“Add Row”按钮可以向表格中增加新的一行数据，
“Del Row”按钮可以删除表格的最后一行，“Add Column”按钮可以增加新的一列，“Del Column”按钮可以删除表格的最后一列
